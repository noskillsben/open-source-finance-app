-- At down_revision f7a4d9e52b30 there is no category_account_link table. A category holding an
-- earmarked move and a transfer into an on-budget savings account must come through with every
-- balance untouched, and the new link table must start empty.
...
INSERT INTO account (id, name, created_on, opening_stated_on, type, on_budget, on_budget_floor_cents, owner_id)
VALUES (2, 'TFSA', '2026-01-01', '2026-01-01', 'Savings', true, 0, 1);
