-- At down_revision 6c1b8e93f5a7 the transaction table has no income_stream_id. An existing
-- transaction (recorded before named pays could bind to it) must come through with the new
-- column null, and its account's balance must be untouched.
