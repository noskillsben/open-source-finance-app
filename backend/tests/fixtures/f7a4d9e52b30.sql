-- At down_revision e6f3c8d41a29 there is no goal table. A category holding a move and an
-- overspend must come through with its balance untouched, and the new table must start empty.
